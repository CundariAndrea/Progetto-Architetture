...
// =========================================================
// Funzioni di Memoria e Helper
// (Queste servono SEMPRE, sia in C che in Assembly)
// =========================================================

// Rendi queste funzioni NON statiche così l'Assembly le vede
...
#ifdef USE_ASM_IMPL
// CASO A: Stiamo compilando per l'Assembly (make run_asm)
    // Forniamo solo i PROTOTIPI affinché il main.c compili senza errori.
    // Il Linker troverà poi l'implementazione reale nel file .o assembly.
    
    void fit(params* input);
    void predict(params* input);

#else
// CASO B: Stiamo compilando in C puro (make run_c)
// Qui inseriamo tutta l'implementazione originale C.

    // -----------------------------------------------------
    // Inserisci qui sotto le tue funzioni statiche helper
    // (quantize_vector, dist_approx, euclidean_distance...)
    // -----------------------------------------------------
/**
